...
class Map extends Component {
    ...
    _drawRoute = (map,maps,places) => {
        ...
        this._calculateAndDisplayRoute(directionsService, directionsDisplay,map,maps,places);
         
    }

    _calculateAndDisplayRoute = (directionsService, directionsDisplay,map,maps,places) => { 
        let waypts = places.map(place => {
            return {location:place.formatted_address,
                    stopover: true};             
        });
        console.log(waypts);
        // waypts.push({
        ...
        return (        
            <Fragment > 
                <div id="map" style={{height:"100vh",float:"left",width:"75%"}}>
                    ...
                    bootstrapURLKeys={{key: 'AIzaSyC27MugzGiY-9Wi2b_8j4-xBuxMJEj-nY8',language:"ta",libraries: ['places', 'geometry', 'drawing'], }}            
                ...
                <div id="right-panel" style={{margin: "20px", "border-width":"2px",width:"20%",height:"400px",float:"left", "text-align":"left","padding-top":"0"}}>
                    ...
                    <button onClick={({map, maps, places}) => this._drawRoute(map, maps, places)} >Click</button>
